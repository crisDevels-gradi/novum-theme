...
ReCharge.Endpoints = {
    ...
    update_billing_address: function(id) {
        return attachQueryParams(`${this.base}payment_source/${id ? id : '1'}/address`);
    },
...
ReCharge.translations = {
    shipping: {
        addAddressBtn: `{{ 'cp_shipping_add_btn' | t }}`,
    ...
    subscription: {
        ...
        paymentMethod: {
            ...
            otherHeader: `{{ 'cp_subscription_update_payment_method_other_header' | t }}`,
        ...
        address: {
            ...
            currentHeader: `{{ 'cp_subscription_update_address_current_header' | t }}`,
            otherHeader: `{{ 'cp_subscription_update_address_other_header' | t }}`,
            noResults: `{{ 'cp_subscription_update_address_no_results' | t }}`,
            changeBtn: `{{ 'cp_subscription_update_address_change_btn' | t }}`,
            success: `{{ 'cp_subscription_update_address_success' | t }}`,
            shippingAndBillingHeader: `{{ 'cp_subscription_shipping_and_billing_header' | t }}`,
            pairChangeBtn: `{{ 'cp_subscription_update_pair_button' | t }}`,
            pairSuccess: `{{ 'cp_subscription_update_pair_success' | t }}`,
            editShippingAndBilling: `{{ 'cp_subscription_edit_shipping_and_billing' | t }}`
        }
    },
    email: {
